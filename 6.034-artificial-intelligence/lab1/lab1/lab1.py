...
# family_rules.
family_rules = [IF( 'male (?x)', THEN('same-identity (?x) (?x)')),
                ...
                IF( AND('parent (?a) (?x)','parent (?b) (?y)', OR('sister (?a) (?b)','brother (?a) (?b)')), THEN('cousin (?x) (?y)')),
                IF( AND('parent (?a) (?x)','parent (?b) (?y)', OR('sister (?a) (?b)','brother (?a) (?b)')), THEN('cousin (?y) (?x)')),
...
HOW_MANY_HOURS_THIS_PSET_TOOK = 'I dont go here'
WHAT_I_FOUND_INTERESTING = 'I dont go here'
WHAT_I_FOUND_BORING = 'I dont go here'
