...
public class PiGeneratorTest {
    ...
    public void bPowerModTest() {
    	assertEquals(17, PiGenerator.powerMod(17, 1, 23));
    	assertEquals(1, PiGenerator.powerMod(17, 0, 23));
    	assertEquals(3, PiGenerator.powerMod(2,7,5));
    }
    
    public void cPowerModTest() {
    	assertEquals(128, PiGenerator.powerMod(2, 7, 1));
    	assertEquals(3, PiGenerator.powerMod(2,7,5));
    }
    
    public void oneDigPiHexTest() {
